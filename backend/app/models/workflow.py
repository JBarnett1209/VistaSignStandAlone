...
class Workflow(Base):
    ...
    # The envelope created when this workflow is sent (the DocuSign-style
    # execution of the workflow). Set by send_workflow.
    envelope_id = Column(UUID(as_uuid=True), nullable=True)
